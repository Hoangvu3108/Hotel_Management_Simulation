...
void add_room(){
    RoomManager room;
    int arr[] = {101,102,103,201,202,203,204,205,206,301,302,303,304,305,306,401,402,403,404,405,406,
...
void book_room(){
    GuessEmployee guess;
    guess.BookRoom(101, "HoangLong", "09754411125", "12h30-16/1/2022");
    guess.BookRoom(301, "HoangPhi", "0345791592", "20h30-16/1/2022");
    guess.BookRoom(201, "HoangPhuong", "069442515", "3h30-16/1/2022");    
}   
...
void add_employee(){
    ...
    manageemp.addEmployee(accountList,"HoangLongVu","0398755446","LT");
    manageemp.addEmployee(accountList,"HoangNhatMinh","0975487456","TV");
    manageemp.addEmployee(accountList,"DangThanhHuyen","021578154","BV");
    manageemp.addEmployee(accountList,"HoangBom","0152548856","DB");
...
void add_service(){
    ...
    service.AddService(CAR_PARKING,426);
}
